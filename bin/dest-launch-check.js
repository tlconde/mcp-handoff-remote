 ...
 *   7. origin.project_state.project_id binds cwd when dir is omitted.
 *
...
(async () => {
  ...
  console.log('dest-launch-check: OK — enrolled origin, dest probe/name/default, workspace bind, duplicate guard.');
})().catch(e => {
