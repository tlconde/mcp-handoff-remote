  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        subscription: { type: 'string', description: 'The vendor account THIS conversation runs under — its own vendor, whatever that is: grok, claude, mistral, cursor, … One word. Do not name a vendor you are not; the examples are examples, not the allowed set.' },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        subscription: { type: 'string', description: 'The vendor account THIS seat runs under — its own vendor, whatever that is: grok, claude, mistral, cursor, … One word. Do not name a vendor you are not.' },
